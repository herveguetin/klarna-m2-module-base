...
namespace Klarna\Base\Config\Converter;
...
class Dom implements ConverterInterface
{
     ...
     */
    public function getChildrenByName(\DOMElement $parent, $name, $asArray = true)
    {
    ...
    /**
     * Iterate through tree from parent node building an array of all elements and their values
     *
     * @param \DOMElement $parent
     * @return array
     */
     ...
     * @return array
     */
    public function collectChildren(\DOMElement $rootNode, string $childName, $idField = 'id')
    {
        $result = [];
    ...
    /**
     * Collecting the order lines
     *
     * @param array $rootNode
     * @return array
     */
    public function collectOrderLines(array $rootNode)
    {
        $result = [];
